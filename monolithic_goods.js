 ...
 */
 ...
 function register(method,pathname,params,cb){
     ...
     if(params.name == null || params.category == null || params.price == null || params.description == null){
         ...
         connection.connect();
         connection.query("insert into goods(name,category,price,description) values(?,?,?,?)",[params.name, params.category, params.price, params.description]
        , (error, result, fields) =>{
            if(error){
                response.errorcode = 1;
 ...
 */
  ...
  * @param {*} cb           콜백
  */
 function uregister(method, pathname,params,cb){
     var response ={
         key:params.key,
         errorcode:1,
         errormessage:"success"
